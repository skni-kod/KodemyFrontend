...
const BellPhoneDropDownMenu = () => {
	...
	return (
		<div className="bg-white2darkgrey h-[auto] w-[323px] absolute top-[197px] right-[20px] shadow-md rounded-lg">
...
export default BellPhoneDropDownMenu;
